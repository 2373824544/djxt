...
function uploadFile_grade($file,$filetempname) 
{
	//自己设置的上传文件存放路径
	$filePath = 'upFile/';
	$str = "";
...
function uploadFile_ems($file,$filetempname) 
{
	//自己设置的上传文件存放路径
	$filePath = 'upFile/';
	$str = "";
	//下面的路径按照你PHPExcel的路径来修改
	set_include_path('.'. PATH_SEPARATOR .'D:\phpStudy\WWW\student_score\admin\PHPExcl' . PATH_SEPARATOR .get_include_path()); 
